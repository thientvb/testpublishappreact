...
function App() {
  const s1 = React.createElement('h1', {
    id: 'h1-1',
    title: 'thẻ h1',
    style: {
      color: 'red'
  ...
  // console.log(s1); 
  const s2 = React.createElement('ul', {}, React.createElement('li'), React.createElement('li'));
  // console.log(s2);
  return (
    <>
      ...
      <div className="flex-none w-56 relative">
        <img src="https://tailwindcss.com/_next/static/media/fancy-suit-jacket.380b02296e758f6a462590ecfb936789.jpg" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
        <form className="flex-auto p-6 border">
          ...
          <div className="flex space-x-4 mb-5 text-sm font-medium">
            ...
            <button className="flex-none flex items-center justify-center w-9 h-9 rounded-full text-violet-600 bg-violet-50" type="button" aria-label="Like">
              <svg width="20" height="20" aria-hidden="true">
                <path clip-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
              </svg>
            </button>
          </div>
